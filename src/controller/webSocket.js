...
import Url from 'url';
import { conntecToDB } from "../dbConfig.js";
    ...
    try {
        ...
        sockserver.on('connection', async (ws, req) => {
            try {
                ...
                console.log(`Reciver ID ${receiverId} connected!`);
